...
class Delete_MainWindow(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(635, 533)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "delete_data_Window"))
        self.label.setText(_translate("Dialog", "选择要删除的工程"))
        self.QComboBox_file.setItemText(0, _translate("Dialog", "选择删除工程"))
